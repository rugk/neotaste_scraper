"""Tests for scraper for the actual restaurant deals of neotaste_scraper."""

from unittest.mock import patch

from neotaste_scraper.restaurant_scraper import fetch_restaurants_from_api
from tests.test_tools import DummyResp, load_json
